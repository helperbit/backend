...
import { signup, login, checkToken, createAdmins, verifyFake, 
	addAdmins, geolocalizeAsAffected } from '../../tests.shared/middlewares/user';
import { signMultisig, createMultisig, feedMultisig, balance, 
	faucet, withdrawFee, getWallet} from '../../tests.shared/middlewares/wallet';
import { frisbyChain } from '../../tests.shared/middlewares/frisby-chain';


/* Create admins */
frisbyChain({ username: 'testmultisig_ms1' }, [
	common.cleanResources('testmultisig'),

	createAdmins('testmultisig'),

	(data, next) => next({
		username: 'testmultisig_msmaster',
		usertype: 'npo',
		admins: data.admins,
