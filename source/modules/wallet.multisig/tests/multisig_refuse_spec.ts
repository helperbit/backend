...
import {
	signMultisigWithRefuse, createMultisig, feedMultisig, balance,
...
/* Create admins */
frisbyChain({ username: 'testmultisigrefuse_ms1' }, [
	common.cleanResources('testmultisigrefuse'),

	createAdmins('testmultisigrefuse'),

	(data, next) => next({
		username: 'testmultisigrefuse_msmaster',
		usertype: 'npo',
		admins: data.admins,
