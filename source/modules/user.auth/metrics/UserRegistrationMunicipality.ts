...
const query = { usertype: 'npo', subtype: 'municipality' };

export default class UserRegistrationMunicipalityMetric implements BackofficeMetric {
	code = "user-registration-municipality";
	ui = {
		name: "Municipality Registration",
		description: "Municipality user registration",
		icon: 'fa-bank',
		enabled: false,
		category: 'User'
	};
