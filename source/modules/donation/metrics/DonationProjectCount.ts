...
export default class DonationProjectCountMetric implements BackofficeMetric {
	code = "donation-project-count";
	ui = {
		name: "Donation Project Count",
		description: "Donations to projects",
		icon: 'fa-bitcoin',
		enabled: false,
		category: 'Donation'
	};
