...
const query = { status: 'confirmed', 'to.project': { $ne: null } };

export default class DonationProjectVolumeMetric implements BackofficeMetric {
	code = "donation-project-volume";
	ui = {
		name: "Donation Project Volume",
		description: "Volume of donations to projects",
		icon: 'fa-bitcoin',
		enabled: false,
		category: 'Donation'
	};
