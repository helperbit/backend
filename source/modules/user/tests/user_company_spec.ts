...
frisbyChain({ username: 'testusercompany_company', usertype: 'company' }, [
	common.cleanResources('testusercompany'),
	userMW.signup,
	userMW.login,
	userMW.checkToken,
	function (data, next) {
		frisby.create('/me - company profile noauth')
			.get(common.api + 'me')
			.expectStatus(401).expectJSON({ error: 'E1' })
			.toss();

		frisby.create('/me - company profile')
			.get(common.api + 'me')
			.expectStatus(200)
			...
			.expectJSON({
				usertype: "company",
				username: "testusercompany_company",
				email: "testusercompany_company@gmail.com",
				supportedevents: [],
				bio: { en: '' },
				country: '',
				zipcode: '',
