...
const query = { 'location.coordinates': { $ne: [] } };

export default class UserGeolocalizedMetric implements BackofficeMetric {
	code = "user-geolocalized";
	ui = {
		name: "User Geolocalized",
		description: "User geolocalized",
		icon: 'fa-user',
		enabled: false,
