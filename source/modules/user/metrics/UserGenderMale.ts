...
const query = { 'usertype': 'singleuser', 'gender': 'm' };

export default class UserGenderMaleMetric implements BackofficeMetric {
	code = "user-gender-male";
	ui = {
		name: "User Gender Male",
		description: "Single User with male geneder",
		icon: 'fa-male',
		color: '#00b5ff',
		enabled: false,
		category: 'User'
