...
const query = { 'location.coordinates': { $eq: [] } };

export default class UserNotGeolocalizedMetric implements BackofficeMetric {
	code = "user-not-geolocalized";
	ui = {
		name: "User Not Geolocalized",
		description: "User not geolocalized and not verified",
		icon: 'fa-user',
		enabled: false,
