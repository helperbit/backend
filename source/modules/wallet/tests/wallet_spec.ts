...
import {
	createP2SHP2WSH, clearIntervals, faucet, getWallet, balance,
...
const chain = new TestChain('testwallet', { enableBitcoin: true });
chain.pushData({ username: 'testwallet_wallet1' });
chain.push(signup);
chain.push(login);
